...
module.exports = async (req, res) => {
    ...
    const map = { entity_eat: { color: 0x9266CC, message: `\`🍇\` **· ${body.cause} \`${body.userid}\` está comendo ${body.victim}!**` }, burn: { color: 0xFF6723, message: `\`🔥\` · **${body.doer} \`${body.userid}\` está queimando ${body.victim}!**` }, break: { color: 0x989EA2, message: `\`🦏\` · **${body.doer} \`${body.userid}\` está quebrando ${body.victim}!**` } };
