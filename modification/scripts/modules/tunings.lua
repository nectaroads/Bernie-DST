...
TUNING.DEERCLOPS_ATTACK_PERIOD = 4
...
TUNING.WALRUS_MAX_STUN_LOCKS = 1

TUNING.EATROCK_NUMUSES = 24
...
TUNING.MARBLESHRUB_MINE_SMALL = 4
TUNING.MARBLESHRUB_MINE_NORMAL = 6
TUNING.MARBLESHRUB_MINE_TALL = 8
TUNING.MARBLESHRUB_GROW_TIME =
{
    { base = 9.0 * 200, random = 1.0 * 200 },
    { base = 9.0 * 200, random = 1.0 * 200 },
    { base = 9.0 * 200, random = 1.0 * 200 },
}

TUNING.WORTOX_SOULHEAL_RANGE = 6
TUNING.WORTOX_SOULHEAL_LOSS_PER_PLAYER = 3
TUNING.WORTOX_SOULHEAL_MINIMUM_HEAL = 2
