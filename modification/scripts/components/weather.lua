...
return Class(function(self, inst)
    ...
    local function CalculateLight()
        ...
        local season = (SEASON_DYNRANGE_DAY[_season] and _season) or "autumn"
        ...
        local dynrange = snowlight and (_daylight and SEASON_DYNRANGE_DAY["winter"] or SEASON_DYNRANGE_NIGHT["winter"])
            or (_daylight and SEASON_DYNRANGE_DAY[season] or SEASON_DYNRANGE_NIGHT[season]) or (_daylight and 0.4 or 0.25)
